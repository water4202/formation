...
def odom(msg):
	...
	b = np.array([ \
				  np.linalg.norm((P3-PO)[:2])**2 - d_safe**2 \
				  ])
...
def	controller():
	...
	u_des = np.array([1*((P2[0] - P3[0]) - 1.0 + (P1[0] - P3[0]) + 1.0) + 1*((tra[0] - P3[0]) + 0),1*((P2[1] - P3[1]) + sqrt(3) + (P1[1] - P3[1]) + sqrt(3)) + 1*((tra[1] - P3[1]) + 2*sqrt(3)/3),0.5 - P3[2]])
